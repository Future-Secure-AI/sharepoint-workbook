 ...
 * @param origin The top-left cell reference (e.g., "A1") where the insertion begins.
 * @param shift The direction to shift existing cells: "Down" to insert rows, "Right" to insert columns.
 * @param cells A 2D rectangular array of cell values or partial cell objects to insert. All rows must have the same length.
